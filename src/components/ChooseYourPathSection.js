...
export default function ChooseYourPathSection({ revealUp }) {
  const paths = [
    ...
    },
    {
      ...
      body: "If you’ve been feeling blocked, disconnected, or creatively heavy, begin with the free Creative Clarity Guide and reconnect with your rhythm.",
      cta: "Get Your Creative Clarity Guide",
      href: "#lead-magnet",
      tint: "bg-blueTint",
    },
    {
