      ...
      <div className="max-w-7xl mx-auto px-6 py-20 md:py-24">
        <Reveal>
          <SectionIntro
            ...
            body="Each workbook targets a specific creative block. Download the PDF, work through it, keep it. $25 each, or get all five plus the full Companion guide for $97."
          />
        </Reveal>
